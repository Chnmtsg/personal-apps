...
| Severity | Meaning |
|---|---|
| Critical | Data loss, a re-judged past day, a wrong streak or level, a broken hard constraint from `project.md`, a security hole, or the app is unusable. Blocks release. |
