...
Read knowledge/coding-standards.md and knowledge/project.md.
...
2. Read the data layer first. In a finance application, data correctness outranks everything.
...
Is currency stored in a form that cannot drift?

Is rounding defined once and applied in one place?

Can any calculation silently produce NaN, Infinity, or a wrong sign?

Are dates and time zones handled consistently?
...
Is anything sensitive logged or exposed?

Is every third-party dependency necessary and current?

## Performance

Is anything quadratic over a growing transaction list?
...
What blocks the long-term vision in knowledge/project.md?
